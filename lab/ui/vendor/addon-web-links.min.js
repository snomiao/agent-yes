...
!(function (e, t) {
  ...
  (() => {
          ...
          class o {
            static computeLink(e, t, r, i) {
              ...
              for (; (d = s.exec(l)); ) {
                ...
                const h = { start: { x: s + 1, y: t + 1 }, end: { x: l, y: a + 1 } };
                p.push({ range: h, text: e, activate: i });
              }
              return p;
            }
            static _getWindowedLineStrings(e, t) {
              ...
              if ((n = t.buffer.active.getLine(e))) {
                ...
                if (n.isWrapped && " " !== e[0]) {
                  for (
                    i = 0;
                    (n = t.buffer.active.getLine(--o)) &&
                    i < 2048 &&
                    ((s = n.translateToString(!0)),
                    (i += s.length),
                    a.push(s),
    ...
    return (
      (() => {
        var e = o;
        (Object.defineProperty(e, "__esModule", { value: !0 }), (e.WebLinksAddon = void 0));
        const t = n(6),
          r = /(https?|HTTPS?):[/]{2}[^\s"'!*(){}|\\\^<>`]*[^\s"':,.!?{}|\\\^~\[\]`()<>]/;
        function i(e, t) {
          const n = window.open();
